<?php
	...
	function the_custom_html_title() {
    	$title = get_the_title();
    	$title = preg_replace('/\*\*(.*)\*\*/', '</br><b class="highlight-word">$1</b>', $title);
    	echo $title;
	}
	...
	function edit_global_custom_fields() {
		...
		<div class='wrap'>
			...
			<form method="post" action="options.php">
				...
				<h2>Partage Facebook</h2>

				<p><strong>Titre :</strong><br />
				<input type="text" name="newsletter" size="150" value="<?php echo get_option('facebook_title'); ?>" /></p>

				<p><strong>Description :</strong><br />
				<input type="text" name="newsletter" size="150" value="<?php echo get_option('facebook_description'); ?>" /></p>
