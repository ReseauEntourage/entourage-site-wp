    ...
    map.init = function(position) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          map.markersCustomCSS();
          google.maps.event.addListener(map.mapObject, 'zoom_changed', map.markersCustomCSS);

          map.checkArea();
          google.maps.event.addListener(map.mapObject, 'dragend', map.checkArea);
