  ...
  .component('userPicture', {
    ...
    controller: function($scope, $uibModal) {
      ...
      ctrlParent.refreshUser = function() {
        ...
        } else if (ctrlParent.user.partner.large_logo_url) {
          ctrlParent.imageUrl = ctrlParent.user.partner.large_logo_url;
        } else {
          ctrlParent.imageUrl = ctrlParent.user.avatar_url;
        }
