...
function getVerbatim() {
  var verbatim = [
    {
      title: "\"1 sourire, ça vaut 100 sandwiches\"",
      subtitle: "Pierrot, SDF"
    },
    {
      title: "\"Pas la peine d’avoir un toit ou des millions dans la poche si on n’a pas l’amitié\"",
    ...
    {
      title: "Moi, Pablo, je ne suis pas SDF. Je suis père de 3 enfants, je suis peintre, je suis un excellent joueur de pétanque...",
      subtitle: "Pablo, SDF"
    },
    {
      title: "Jamais je ne m'en serai sortie sans l'aide de mes voisins",
      subtitle: "Anne-Claire, ancienne SDF"
    },
    {
      title: "143 000 personnes SDF en France, dont 30.000 enfants",
      subtitle: "source : Fondation Abbé Pierre, 2017"
    },
    {
      title: "85% des SDF disent ressentir le rejet des passants",
      subtitle: "Etudes BVA/Emmaüs"
    },
    {
      title: "Si tu savais la chaleur que ça me fait quand on me dit bonjour",
      subtitle: "Kenny, ancien SDF"
    },
  ];
  return verbatim[Math.floor(Math.random() * verbatim.length)];
}