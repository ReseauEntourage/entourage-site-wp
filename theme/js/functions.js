...
function isDemoMode() {
  return window.location.hostname == 'localhost' ||
         window.location.hostname.split('.').slice(-1)[0] === 'localhost';
}
...
function getVerbatim() {
  var verbatim = [
    ...
    {
      title: "\"Pas la peine d’avoir un toit ou des millions<br> dans la poche si on n’a pas l’amitié\"",
    ...
    {
      title: "143 000 personnes SDF en France,<br> dont 30 000 enfants",
      subtitle: "source : Fondation Abbé Pierre, 2017"
    },
    {
      title: "85% des SDF disent ressentir<br> le rejet des passants",
